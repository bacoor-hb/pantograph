    ...
    return (
      <div className="metametrics-opt-in">
        <div className="metametrics-opt-in__main">
          ...
          <div className="metametrics-opt-in__title">Help Us Improve Pantograph</div>
          <div className="metametrics-opt-in__body">
            <div className="metametrics-opt-in__description">
             Pantograph would like to gather usage data to better understand how our users interact with the extension. This data
             will be used to continually improve the usability and user experience of our product and the TomoChain ecosystem.
            </div>
            <div className="metametrics-opt-in__description">
             Pantograph will..
            </div>
          ...
          <div className="metametrics-opt-in__footer">
            ...
            <div className="metametrics-opt-in__bottom-text">
              ...
              <a
                href="https://pantograph.io/privacy-policy"
                target="_blank"
