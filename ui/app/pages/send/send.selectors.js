...
function getGasPrice (state) {
  return state.metamask.send.gasPrice || getSlowPriceEstimateInHexWEI(state)
}
...
function getTokenIssuer (state) {
  return state.metamask.tokenIssuer
}

function getEstimateGasError (state) {
  return state.send.errors.estimateGas
}