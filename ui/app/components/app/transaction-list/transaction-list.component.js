...
export default class TransactionList extends PureComponent {
  ...
  renderTransactions () {
    ...
    const { selectedIdentity, network, rpcPrefs, pendingTransactions = [], completedTransactions = [] } = this.props
      ...
      <div className="transaction-list__transactions">
        ...
        <div className="transaction-list__completed-transactions">
          <div className="transaction-list__header">
            ...
            <Button
              type="secondary"
              className="transaction-list__header__button_view_tomoscan"
              onClick={() => {
                global.platform.openWindow({ url: genAccountLink(selectedIdentity.address, network, rpcPrefs) })
              }}
            >
