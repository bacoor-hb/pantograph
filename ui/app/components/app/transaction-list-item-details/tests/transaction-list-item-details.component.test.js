...
describe('TransactionListItemDetails Component', () => {
  ...
  it('should disable the Copy Tx ID and View In TomoScan buttons when tx hash is missing', () => {
    const transaction = {
      history: [],
      id: 1,
      status: 'confirmed',
  ...
  it('should render functional Copy Tx ID and View In TomoScan buttons when tx hash exists', () => {
    const transaction = {
      history: [],
      id: 1,
      status: 'confirmed',
