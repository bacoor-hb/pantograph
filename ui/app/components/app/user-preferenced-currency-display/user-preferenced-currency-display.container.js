...
import { ETH, TOMO, PRIMARY, SECONDARY } from '../../../helpers/constants/common'
...
const mergeProps = (stateProps, dispatchProps, ownProps) => {
  ...
  if (type === PRIMARY && useNativeCurrencyAsPrimaryCurrency ||
    ...
    // Display Fiat
    numberOfDecimals = propsNumberOfDecimals || fiatNumberOfDecimals || 6
