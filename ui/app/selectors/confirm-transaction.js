...
export const getTokenIssuer = state => state.metamask.tokenIssuer
...
export const transactionFeeSelector = function (state, txData) {
  ...
  const fiatTransactionAmount = getValueFromWeiHex({
    value, fromCurrency: nativeCurrency, toCurrency: currentCurrency, conversionRate, numberOfDecimals: 6,
  })
