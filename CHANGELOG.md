...
- [#7426](https://github.com/MetaMask/metamask-extension/pull/7426): Ensure TomoScan result is valid before reading it (#7426)
...
- [#4591](https://github.com/MetaMask/metamask-extension/pull/4591): Allow Copying Token Addresses and link to Token on TomoScan.
...
- Added info link on account screen that visits TomoScan.
...
- Replaced TomoScan main-net provider with our own production RPC.
